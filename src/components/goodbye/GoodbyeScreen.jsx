...
const GoodbyeScreen = () => {
  return (
    <div className="container">
      ...
      <p className='text-light fw-bold'>A partir del <span className='text-danger'>01/01/2023</span>, no tomaré más fechas. Una etapa que termina, una nueva que comienza...</p>
